<?php
    ...
    use core\read\arrays\Seo\FootnoteReader;
    use core\read\providers\Seo\FootnoteProvider;
    ...
    class FootnoteController extends MainController
    {
        protected const int        TEXT_TYPE         = Footnote::TEXT_TYPE;
        protected const string     MODEL_PREFIX      = Footnote::MODEL_PREFIX;
        protected const string     MODEL_LABEL       = Footnote::MODEL_LABEL;
        protected const string     CACHE_TAG         = Footnote::CACHE_TAG;
        protected const array      DEFAULT_FIELDS    = Footnote::DEFAULT_FIELDS;
        protected const bool       MODEL_CACHE_INDEX = Footnote::CACHE_INDEX;
        protected const bool       MODEL_CACHE_VIEW  = Footnote::CACHE_VIEW;
        
        private FootnoteProvider $provider;
        private FootnoteReader   $reader;
        
        public function __construct(
            $id,
            $module,
            FootnoteProvider $provider,
            FootnoteReader $reader,
        ...
        {
            $package = $this->reader->getFullPackedFootnoteById($id);
            if (!$package) {
