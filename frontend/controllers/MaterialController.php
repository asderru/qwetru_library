<?php
    ...
    use core\read\arrays\Seo\MaterialReader;
    use core\read\providers\Seo\MaterialProvider;
    ...
    {
        protected const int        TEXT_TYPE         = Material::TEXT_TYPE;
        protected const string     MODEL_PREFIX      = Material::MODEL_PREFIX;
        protected const string     MODEL_LABEL       = Material::MODEL_LABEL;
        protected const string     CACHE_TAG         = Material::CACHE_TAG;
        protected const array      DEFAULT_FIELDS    = Material::DEFAULT_FIELDS;
        protected const bool       MODEL_CACHE_INDEX = Material::CACHE_INDEX;
        protected const bool       MODEL_CACHE_VIEW  = Material::CACHE_VIEW;
        ...
        {
            $package = $this->reader->getFullPackedMaterialById($id);
            if (!$package) {
