<?php
     ...
     * @var bool       $isPage Whether the current page is a razdel
     */
    
    function buildPageMenu(
        array $items, ?int $activeId, bool $isPage, int $parentLft = 1, int $parentRgt = PHP_INT_MAX, int $depth = 1,
    ): string
    {
        $result = '';
    ...
    echo buildPageMenu($models, $activeId, $isPage);
?>
